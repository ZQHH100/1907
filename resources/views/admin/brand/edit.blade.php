...
<body>
	<h3>品牌修改</h3><a href="{{url('brand')}}">列表</a><hr/>
	...
	<div class="form-group">
		...
		<div class="col-sm-10">
		   <img src="{{env('UPLOAD_URL')}}{{$data->brand_logo}}" width="100">
			<input type="file" class="form-control" value="{{$data->brand_logo}}" name="brand_logo" id="lastname" 
	...
	<div class="form-group">
		...
		<div class="col-sm-10">
			<textarea type="file" class="form-control" value="" name="brand_desc" id="lastname" 
