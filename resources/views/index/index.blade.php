    ...
    @foreach($IndexInfo as $v)
      <div class="index-pro1-list">
       ...
       <dl>
        ...
        <dd class="ip-text"><a href="proinfo.html">{{$v->goods_name}}</a><span>已售：{{$v->goods_sum}}</span></dd>
        <dd class="ip-price"><strong>¥{{$v->goods_price}}</strong> <span>¥{{$v->goods_score}}</span></dd>
       </dl>
